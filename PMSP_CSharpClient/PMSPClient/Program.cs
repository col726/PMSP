                    ...
                    while (1 == 1)
                    {
                        ...
                        switch (menu.SelectedOption.ToString())
                        {
                            ...
                            case "T":
                                ...
                                //Get all tracks.
                                tracks = Track.GetList(protocol, ListType.Track, null);
                                ...
                                if (tracks.Count > 0)
                                {
                                    ...
                                    {
                                        Console.WriteLine(track.Id + ". " + track.Title + " by " + track.Artist.Name);
                                    }
                                }
                                ...
                                while (1 == 1)
                                {
                                    ...
                                    try
                                    {
                                        selectedTrack = tracks[Convert.ToInt32(Console.ReadLine()) - 1];
                                        break;
                                    }
                                    catch (Exception ex)
                                    {
